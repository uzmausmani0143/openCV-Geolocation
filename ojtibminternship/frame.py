...
known_faces_dir = r"C:\Users\NSTIB34\ojtibminternship\known"

# Directory to save images of unknown persons
unknown_faces_dir = r"C:\Users\NSTIB34\ojtibminternship\unknown"
...
screen_width = 1920  # Example screen width, replace with your actual screen width
screen_height = 1080  # Example screen height, replace with your actual screen height

# Calculate the top-left corner position to center the window
x_center = int((screen_width - window_width) / 2)
y_center = int((screen_height - window_height) / 2)
...
cv2.moveWindow('Video', x_center, y_center)
...
while True:
    ...
    # Resize the frame (increase size if needed)
    frame = cv2.resize(frame, (window_width, window_height))  # Resize frame to window size
    ...
    # Display the resulting frame in the center of the window
